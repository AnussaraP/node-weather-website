...
const forecast =(latitude,longtitude,callback)=>{
   ...
   //const url = 'http://api.weatherstack.com/current?access_key=d752dde4fc101d46c7ae5b756eb1a682&query='+ location //'50.7183,-1.8833'
...
request({url:url, json:true},(error,{body})=>{ //this was responce but change to {body} shorter object 
    if(error){
        ...
        callback(undefined,
            ...
            + body.current.temperature + ' degree.' + ' But it feels like ' + body.current.feelslike + ' degree out there',
